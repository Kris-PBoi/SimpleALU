...
void VadderTb___024root___eval_triggers__act(VadderTb___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VadderTb___024root___eval_triggers__act\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__VactTriggered.set(0U, ((IData)(vlSelfRef.adderTb__DOT__uut__DOT__carry_int) 
                                       != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__adderTb__DOT__uut__DOT__carry_int__1)));
