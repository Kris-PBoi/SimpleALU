...
extern const VlWide<12>/*383:0*/ VadderTb__ConstPool__CONST_hd74291de_0;
...
VL_ATTR_COLD void VadderTb___024root___eval_initial__TOP(VadderTb___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VadderTb___024root___eval_initial__TOP\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSymsp->_vm_contextp__->dumpfile(VL_CVT_PACK_STR_NW(12, VadderTb__ConstPool__CONST_hd74291de_0));
