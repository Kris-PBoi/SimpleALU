...
VL_ATTR_COLD void Vadder___024root___eval_initial__TOP(Vadder___024root* vlSelf) {
    ...
    VL_WRITEF_NX("a = 10010101\nb = 11010010\nsum = %0b\ncarry = %0b\n",0,
                 8,vlSelfRef.adderTb__DOT__sum,1,(IData)(vlSelfRef.adderTb__DOT__carry));
}
...
VL_ATTR_COLD void Vadder___024root___stl_sequent__TOP__0(Vadder___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.adderTb__DOT__sum = ((IData)(vlSelfRef.adderTb__DOT__a_i) 
                                   ^ (IData)(vlSelfRef.adderTb__DOT__b_i));
    vlSelfRef.adderTb__DOT__carry = (1U & ((IData)(vlSelfRef.adderTb__DOT__a_i) 
                                           & (IData)(vlSelfRef.adderTb__DOT__b_i)));
}
...
VL_ATTR_COLD void Vadder___024root___ctor_var_reset(Vadder___024root* vlSelf) {
    ...
    vlSelf->adderTb__DOT__carry = VL_RAND_RESET_I(1);
}
